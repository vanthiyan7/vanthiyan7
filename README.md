...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Hey%2C+I'm+Vanthiyath+Thevan+%F0%9F%91%8B;Full-Stack+Developer+%7C+ML+Engineer;250%2B+LeetCode+Problems+Solved;330%2B+GitHub+Contributions+%7C+Always+Learning" alt="Typing SVG" />
</div>
...
public class VanthiyathThevan {
    ...
    String funFact = "I trained 45+ students while being an intern!";

    String motto() {
        return "Write clean code. Solve real problems.";
    }
}
```
...
<details>
  <summary><strong>iTech Technologies</strong> — Student Intern &nbsp;|&nbsp; Aug 2024 – Aug 2025 &nbsp;|&nbsp; India (On-site)</summary>
  <br/>

  > `Java` `C` `Mentoring` `Software Development` `Problem Solving`

  - Gained deep proficiency in **C** and **Java** through hands-on real-world project work.
  - **Trained 45+ students** in C and Java programming, strengthening both pedagogy and technical depth.
  - Mentored junior team members, building leadership capabilities alongside engineering skills.
  - Developed solutions to complex challenges, reinforcing clean code practices and logical thinking.
...
| 🏆 | Achievement | Details |
|----|-------------|---------|
| 💻 | LeetCode Problem Solving | **250+ problems** solved across DSA topics |
| 🐙 | GitHub Contributions | **330+ contributions** in the last year |
| 👨‍🏫 | Student Mentorship | Trained **45+ students** in C & Java at iTech Technologies |
| 📜 | Certifications | DSA in C, Java App Dev, Web Development — all from iTech Technologies |
...
|--------|-------------|------|-------|
| B.E – Computer Science & Engineering | Anjalai Ammal Mahalingam Engineering College, Thiruvarur | 2020 – 2024 | CGPA: 7.64 |
| Higher Secondary (12th) | Little Scholars Matriculation Hr. Sec. School, Thanjavur | 2019 – 2020 | 70% |
| Secondary (10th) | Little Scholars Matriculation Hr. Sec. School, Thanjavur | 2017 – 2018 | 86% |
...
```
🤖 Machine Learning      →  CNNs, Model Training, scikit-learn, TensorFlow
☁️  Cloud Computing      →  AWS Fundamentals, Deployment, Serverless
🧱 System Design         →  Scalability, Databases, Distributed Systems
🔐 DSA (Advanced)        →  Graphs, DP, Trees — LeetCode Grind
```
